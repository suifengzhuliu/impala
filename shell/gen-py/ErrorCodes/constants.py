...
TErrorMessage = [
  ...
  "Failed to get minimum memory reservation of $0 on daemon $1:$2 for query $3 because it would exceed an applicable memory limit. Memory is likely oversubscribed. Reducing query concurrency or configuring admission control may help avoid this error. Memory usage:\n$4",
