...
public class AggregateFunction extends Function {
  private final static Logger LOG = LoggerFactory.getLogger(AggregateFunction.class);
  ...
  private String analysisSymbol_;
  ...
  public AggregateFunction(FunctionName fnName, List<Type> argTypes,
    ...
    //LOG.info("AggregateFunction  ，the updateFnSymbol is {}" ,updateFnSymbol);
  ...
  public static AggregateFunction createAnalysis(FunctionName fnName, List<Type> argTypes,
	      Type retType, Type intermediateType,
	      HdfsUri location, String updateFnSymbol, String initFnSymbol,
	      String serializeFnSymbol, String mergeFnSymbol, String getValueFnSymbol,
	      String removeFnSymbol, String finalizeFnSymbol,String analysis){
		  AggregateFunction fn = new AggregateFunction(fnName, argTypes, retType,
	              ...
	              finalizeFnSymbol);
	      //LOG.info("createAnalysis the  ana is {} ，the mergeFnSymbol is {}",ana,mergeFnSymbol);
	      if(analysis != null && "true".equals(analysis)){
	             fn.isAnalyticFn_ = true;
	      } 
	      fn.analysisSymbol_ = analysis;
	      return fn;
  }
  ...
  public static AggregateFunction createBuiltin(Db db, String name,
	  ...
	  //LOG.info("......    createBuiltin  the updateFnSymbol is {}",updateFnSymbol);
  ...
  public String getAnalysisSymbol() { return analysisSymbol_; }
  ...
  public void setAnalysisSymbol(String t) { analysisSymbol_ = t; }
  ...
  public String toSql(boolean ifNotExists) {
    ...
    sb.append("ANALYSIS="+getAnalysisSymbol()+ "'\n");
    return sb.toString();
  }
  ...
  public TFunction toThrift() {
    ...
    agg_fn.setAnalysis_symbol(analysisSymbol_);
