...
Status PartitionedAggregationNode::GetNext(
  ...
  //LOG(INFO) << "PartitionedAggregationNode GetNext row_batch SIZE IS  " << row_batch->num_rows();
...
void PartitionedAggregationNode::UpdateTuple(AggFnEvaluator** agg_fn_evals,
  ...
  //  LOG(INFO) << "PartitionedAggregationNode UpdateTuple, the is_merge is " << is_merge << endl
