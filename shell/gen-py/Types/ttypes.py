...
class TAggregateFunction:
  ...
  thrift_spec = (
    ...
    (11, TType.STRING, 'analysis_symbol', None, None, ), # 11
  )

  def __init__(self, intermediate_type=None, is_analytic_only_fn=None, update_fn_symbol=None, init_fn_symbol=None, serialize_fn_symbol=None, merge_fn_symbol=None, finalize_fn_symbol=None, get_value_fn_symbol=None, remove_fn_symbol=None, ignores_distinct=None, analysis_symbol=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.analysis_symbol = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.ignores_distinct is not None:
      ...
      oprot.writeFieldEnd()
    if self.analysis_symbol is not None:
      oprot.writeFieldBegin('analysis_symbol', TType.STRING, 11)
      oprot.writeString(self.analysis_symbol)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
